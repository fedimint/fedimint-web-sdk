...
export default defineVersionedConfig(
  {
    ...
    themeConfig: {
      ...
      sidebar: getSidebar() as any, // Type assertion to avoid compatibility issues
    ...
    versioning: {
      latestVersion: '1.0.0', // Your current version before breaking changes
      // Optional: Custom version ordering
      // versions: ["2.0.0", "1.0.0"], // Newer versions first
    },
  },
  __dirname,
)
